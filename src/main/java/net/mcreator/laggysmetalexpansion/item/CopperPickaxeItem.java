...
public class CopperPickaxeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:copper_pickaxe")
	public static final Item block = null;
	public CopperPickaxeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 43);
	}
