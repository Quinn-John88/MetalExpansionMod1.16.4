...
public class NickleShovelItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:nickle_shovel")
	public static final Item block = null;
	public NickleShovelItem(LaggysMetalExpansionModElements instance) {
		super(instance, 119);
	}
