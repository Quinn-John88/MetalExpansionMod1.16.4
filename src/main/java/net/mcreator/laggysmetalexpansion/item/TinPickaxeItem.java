...
public class TinPickaxeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:tin_pickaxe")
	public static final Item block = null;
	public TinPickaxeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 33);
	}
