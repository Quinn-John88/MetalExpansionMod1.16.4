...
public class BronzeHoeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:bronze_hoe")
	public static final Item block = null;
	public BronzeHoeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 57);
	}
