...
public class SteelSwordItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:steel_sword")
	public static final Item block = null;
	public SteelSwordItem(LaggysMetalExpansionModElements instance) {
		super(instance, 65);
	}
	...
	public void initElements() {
		...
		}, 3, -3.1f, new Item.Properties().group(MetalsExpansionItemGroup.tab).isImmuneToFire()) {
