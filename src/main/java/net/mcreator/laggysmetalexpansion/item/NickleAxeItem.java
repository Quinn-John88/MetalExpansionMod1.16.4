...
public class NickleAxeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:nickle_axe")
	public static final Item block = null;
	public NickleAxeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 117);
	}
