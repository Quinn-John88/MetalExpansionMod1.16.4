...
public class NickleHoeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:nickle_hoe")
	public static final Item block = null;
	public NickleHoeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 120);
	}
