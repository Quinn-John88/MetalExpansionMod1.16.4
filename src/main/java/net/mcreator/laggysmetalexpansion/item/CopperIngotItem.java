...
public class CopperIngotItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(LaggysMetalExpansionModElements instance) {
		super(instance, 5);
	}
