...
public class SteelIngotItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:steel_ingot")
	public static final Item block = null;
	public SteelIngotItem(LaggysMetalExpansionModElements instance) {
		super(instance, 25);
	}
