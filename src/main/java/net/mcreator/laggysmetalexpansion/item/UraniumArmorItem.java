...
public class UraniumArmorItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:uranium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("laggys_metal_expansion:uranium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("laggys_metal_expansion:uranium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("laggys_metal_expansion:uranium_armor_boots")
	public static final Item boots = null;
	public UraniumArmorItem(LaggysMetalExpansionModElements instance) {
		super(instance, 142);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "laggys_metal_expansion:textures/models/armor/uranium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
