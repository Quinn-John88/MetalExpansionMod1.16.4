...
public class UraniumHoeItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:uranium_hoe")
	public static final Item block = null;
	public UraniumHoeItem(LaggysMetalExpansionModElements instance) {
		super(instance, 136);
	}
