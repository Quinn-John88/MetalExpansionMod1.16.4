...
public class UraniumIngotItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:uranium_ingot")
	public static final Item block = null;
	public UraniumIngotItem(LaggysMetalExpansionModElements instance) {
		super(instance, 126);
	}
