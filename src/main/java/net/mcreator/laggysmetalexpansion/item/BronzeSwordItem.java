...
public class BronzeSwordItem extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:bronze_sword")
	public static final Item block = null;
	public BronzeSwordItem(LaggysMetalExpansionModElements instance) {
		super(instance, 55);
	}
