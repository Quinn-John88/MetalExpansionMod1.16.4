...
public class NickleOreBlock extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:nickle_ore")
	public static final Block block = null;
	public NickleOreBlock(LaggysMetalExpansionModElements instance) {
		super(instance, 81);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(NickleIngotItem.block, (int) (1)));
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 7)).range(63).square().func_242731_b(11));
	}
}
