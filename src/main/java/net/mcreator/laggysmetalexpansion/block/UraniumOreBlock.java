...
public class UraniumOreBlock extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(LaggysMetalExpansionModElements instance) {
		super(instance, 127);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(27).square().func_242731_b(4));
	}
}
