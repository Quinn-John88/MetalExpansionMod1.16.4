...
public class CopperOreBlock extends LaggysMetalExpansionModElements.ModElement {
	@ObjectHolder("laggys_metal_expansion:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(LaggysMetalExpansionModElements instance) {
		super(instance, 4);
